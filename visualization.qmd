...
# The data set contains 2x test per time point, so I've decided to take the highest value observed at each
# time point for analysis. This could be done using the summarise() function alone, however, this produced alot of NA's
# and corresponding errors. Therefore I've included the below code, which makes a functions that returns
# proper NA values where all values are NA for a group.
...
# Depending on how you would like to plot the data

...
write_xlsx(condition, "relief_volume") # used for data sharing until data package is up and running
...
write_xlsx(participants, "relief_participants") # used for data sharing until data package is up and running
...
In this example plot, we create one plot per angular velocity, faceted by age_group and allocation.
```{r, Plot2}
